...
struct MultiTenantIndex {
    ...
    faiss_navix::idx_t ntotal; ///< total nb of indexed vectors
    ...
    faiss_navix::MetricType metric_type;
    float metric_arg; ///< argument of the metric type

    explicit MultiTenantIndex(faiss_navix::idx_t d = 0, faiss_navix::MetricType metric = faiss_navix::METRIC_L2)
            : d(d),
              ntotal(0),
              verbose(false),
              is_trained(true),
     ...
     */
    virtual void train(faiss_navix::idx_t n, const float* x, tid_t tid);
     ...
     */
    virtual void add_vector(faiss_navix::idx_t n, const float* x) = 0;
     ...
     */
    virtual void add_vector_with_ids(faiss_navix::idx_t n, const float* x, const faiss_navix::idx_t* xids) = 0;
     ...
     */
    virtual void grant_access(faiss_navix::idx_t xid, tid_t tid) = 0;
     ...
     * @param tid         id of the tenant that is searching
     */
    virtual void assign(faiss_navix::idx_t n, const float* x, tid_t tid, faiss_navix::idx_t* labels, faiss_navix::idx_t k = 1)
            const;
     ...
     */
    virtual bool remove_vector(faiss_navix::idx_t xid) = 0;
     ...
     */
    virtual bool revoke_access(faiss_navix::idx_t xid, tid_t tid) = 0;
     ...
     */
    virtual void reconstruct(faiss_navix::idx_t key, float* recons) const;
     ...
     */
    virtual void reconstruct_batch(faiss_navix::idx_t n, const faiss_navix::idx_t* keys, float* recons)
            const;
     ...
     */
    virtual void reconstruct_n(faiss_navix::idx_t i0, faiss_navix::idx_t ni, float* recons) const;
     ...
     */
    virtual void compute_residual(const float* x, float* residual, faiss_navix::idx_t key)
            const;
     ...
     */
    virtual void sa_encode(faiss_navix::idx_t n, const float* x, uint8_t* bytes) const;
     ...
     */
    virtual void sa_decode(faiss_navix::idx_t n, const uint8_t* bytes, float* x) const;
    ...
    virtual void merge_from(MultiTenantIndex& otherIndex, faiss_navix::idx_t add_id = 0);
